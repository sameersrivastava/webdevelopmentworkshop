var workshop = (function($){
	var buttons = function(){
		$('#html').click( function() {
			$('.page').html(
				'<div class="page-heading"> <h1> This is a header </div> </div>'+
				'<p>Here\'s a paragraph. This is another HTML Element. This is not a very long paragraph. Just to show you know html elements. I am just going to copy some more stuff for the next paragraph. </p>'+
				'<p>Lorem ipsum non sed dictum phasellus eu ac feugiat auctor ut aliquet, pulvinar sagittis imperdiet maecenas cras etiam cursus nostra fusce senectus.</p>'+
				'<p>Fusce arcu lobortis sociosqu at ad aptent ornare commodo cubilia tellus, himenaeos auctor condimentum blandit dolor malesuada fringilla taciti sollicitudin interdum molestie, taciti iaculis aenean enim pretium faucibus fringilla vestibulum convallis.</p>' +
